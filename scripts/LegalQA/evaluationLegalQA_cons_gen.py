"""
Constrained generation evaluation on isaacus/LegalQAEval, with two types of constrained decoding:
- "whole_sequence"
- "token_aware"
...
- Semin et al.'s pooled character-overlap F1, hard and soft, from their
  ...
  LegalQAEval has one label, so hard and soft coincide.
"""
import argparse
import os
import random
...
# Model configuration
# -------------------------
parser = argparse.ArgumentParser("Evaluate constrained generation on LegalQAEval.")
...
labels_for_constrained = LEGALQA_LABELS
