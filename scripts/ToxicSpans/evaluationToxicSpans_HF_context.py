...
for model_name in MODEL_NAMES:
    ...
    intermediate_results_path = f"/home/stulcrad/master_thesis/Experiment_results/ToxicSpans/Context-Based/Csv/HF_context_results_ToxicSpans_{model_short}_bs{BATCH_SIZE}.csv"
