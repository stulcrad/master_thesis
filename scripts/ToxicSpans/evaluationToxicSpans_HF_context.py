...
PRED_DIR = f"{RESULTS_ROOT}/ToxicSpans/Context-Based/Predictions"
...
for model_name in MODEL_NAMES:
    ...
    intermediate_results_path = f"{RESULTS_ROOT}/ToxicSpans/Context-Based/Csv/HF_context_results_ToxicSpans_{model_short}_bs{BATCH_SIZE}.csv"
